...
public class RectangleStrategy implements IShapeStrategy {
	...
	public void filledIn(Point startPoint, Point endPoint, Color PrimaryColor, PaintCanvasBase pc) {
		...
		if (startPoint.getX() > endPoint.getX() && startPoint.getY() < endPoint.getY()) { // top right to bottom left
			graphics2d.fillRect(endPoint.getX(), startPoint.getY(), startPoint.getX() - endPoint.getX(), endPoint.getY() - startPoint.getY());
		} else if (startPoint.getY() > endPoint.getY() && startPoint.getX() > endPoint.getX()) { // bottom right to top
			graphics2d.fillRect(endPoint.getX(), endPoint.getY(), startPoint.getX() - endPoint.getX(), startPoint.getY() - endPoint.getY());
		} else if (startPoint.getY() > endPoint.getY()) { // bottom left to top right
			graphics2d.fillRect(startPoint.getX(), endPoint.getY(), endPoint.getX() - startPoint.getX(), startPoint.getY() - endPoint.getY());
	...
	public void outlined(Point startPoint, Point endPoint, Color PrimaryColor, PaintCanvasBase pc, Stroke stroke) {
		...
		graphics2d.setColor(PrimaryColor);
		if (startPoint.getX() > endPoint.getX() && startPoint.getY() < endPoint.getY()) { // top right to bottom left
			graphics2d.drawRect(endPoint.getX(), startPoint.getY(), startPoint.getX() - endPoint.getX(), endPoint.getY() - startPoint.getY());
		} else if (startPoint.getY() > endPoint.getY() && startPoint.getX() > endPoint.getX()) { // bottom right to top
			graphics2d.drawRect(endPoint.getX(), endPoint.getY(), startPoint.getX() - endPoint.getX(), startPoint.getY() - endPoint.getY());
		} else if (startPoint.getY() > endPoint.getY()) { // bottom left to top right
			graphics2d.drawRect(startPoint.getX(), endPoint.getY(), endPoint.getX() - startPoint.getX(), startPoint.getY() - endPoint.getY());
		} else { // top left to bottom right
